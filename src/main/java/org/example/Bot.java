...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "s1nerg4_testbot";
    }

    @Override
    public String getBotToken() {
        return "6577699576:AAGy07N6nQzU5oryxfpeB7KbOZQNBo3cxeY";
    }
    ...
    private SendMediaGroup preparePhotoMessage(List<String> localPath, ImagesOperation operation, String chatId) throws Exception {
    ...
    private String runCommands(String text) throws InvocationTargetException, IllegalAccessException {
